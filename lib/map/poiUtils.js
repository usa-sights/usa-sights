...
export function normalizePoi(raw = {}) {
  ...
  const commentUserCount = Number(raw.comment_user_count ?? raw.comment_users_count ?? raw.review_comment_user_count ?? 0) || 0
  const favoriteCount = Number(raw.favorite_count ?? raw.favorites_count ?? raw.saved_count ?? 0) || 0
  ...
  return {
    ...
    comment_user_count: commentUserCount,

...
export function normalizePoiRecord(poi = {}) {
  ...
  return {
    ...
    opening_hours_text: normalizeText(item.opening_hours_text ?? item.opening_hours, ''),
    price_info_text: normalizeText(item.price_info_text ?? item.price_info ?? item.prices, ''),
    hotels_nearby_text: normalizeText(item.hotels_nearby_text ?? item.hotels_nearby, ''),
    website_url: normalizeText(item.website_url ?? item.website, ''),
  }
}
